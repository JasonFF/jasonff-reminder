...
// 17259.83 交易量
    ...
    initData(interval) {
        ...
        //   this.initKline1()
        // })
        this.getKline(interval, "usdt_qc", 200).then(res => {
          this.initKline2()
        })
    }
  }
